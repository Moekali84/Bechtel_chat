...
By creating an account, installing the PBIChat visual, or using the PBIChat backend API ("Service"), you agree to these Terms of Service ("Terms"). If you do not agree, do not use the Service.
...
### 2.1 Registration
To access Pro features, you must create an account with a valid email address and password. You may also use the Service without an account under the Free tier (subject to IP-based usage limits).

### 2.2 Account Security
You are responsible for:
- Maintaining the confidentiality of your login credentials and license key
- All activity that occurs under your account
- Notifying us immediately at support@pbichat.com if you suspect unauthorized access

### 2.3 Account Accuracy
You agree to provide accurate and current information during registration and to update it as needed.
...
- Share Pro account credentials or license keys with unauthorized users
...
All payments are processed by **Stripe**. By subscribing, you agree to Stripe's [Terms of Service](https://stripe.com/legal). We do not store your credit card information.
...
### 6.3 Data Security
We implement reasonable security measures including HTTPS encryption, JWT authentication, rate limiting, SQL injection prevention, and credential scrubbing. However, no system is 100% secure.
...
### 7.3 Dependencies
Service availability depends on third-party services (OpenRouter, Supabase, Stripe, your database infrastructure). We are not responsible for outages caused by third-party service interruptions.
